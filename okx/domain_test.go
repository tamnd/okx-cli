...
func TestHostWiring(t *testing.T) {
	...
	if want := "okx://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("okx", "about")
	if err != nil || got.String() != "okx://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want okx://page/about", got.String(), err)
	}
}
