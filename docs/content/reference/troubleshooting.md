...
Most of these come down to network reality or how okx serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

okx rate-limits like any public site. okx already paces
...
Where a surface is gated, okx reads a cookie or token you supply
...
`okx`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what okx actually did
