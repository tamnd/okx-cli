...
```
okx <command> [arguments] [flags]
```

Run `okx <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `okx/domain.go`.
